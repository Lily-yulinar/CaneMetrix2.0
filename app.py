...
with h1:
    st.markdown(f'''<div class="partner-box">
        <img src="data:image/png;base64,{logo_ptpn}" height="32">
        <img src="data:image/png;base64,{logo_sgn}" height="32">
        <img src="data:image/png;base64,{logo_lpp}" height="32">
        <img src="data:image/png;base64,{logo_kb}" height="32">
...
if st.session_state.page == 'dashboard':
    ...
    # Tombol Kembali (Pakai on_click juga)

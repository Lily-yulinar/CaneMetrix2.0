...
# --- 2. CSS STYLING (The Beautiful UI) ---
st.markdown(f"""
    <style>
    ...
    .title-text {{
        ...
        font-size: 60px; letter-spacing: 10px; margin: 0;
    }}
...
# --- 5. GRID MENU (Urutan 1-9) ---
# Kita buat 3 baris, tiap baris 3 kolom
items = [
